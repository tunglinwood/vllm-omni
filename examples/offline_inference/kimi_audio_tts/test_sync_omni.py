#!/usr/bin/env python3
"""Test Kimi-Audio TTS with sync Omni (OmniLLM, not AsyncOmniLLM)."""
...
def test_sync_omni():
    ...
    output_dir = "/root/learning/vllm-omni/examples/offline_inference/kimi_audio_tts/output_sync_test"
    
    os.makedirs(output_dir, exist_ok=True)
    
    print("=" * 80)
    print("SYNC Omni Test (OmniLLM, not AsyncOmniLLM)")
    print("=" * 80)
        ...
        if outputs and len(outputs) > 0:
            ...
            if output.outputs and len(output.outputs) > 0:
                ...
                if audio_data:
                    ...
                    # Save
                    output_path = os.path.join(output_dir, "test_sync.wav")
